package com.android.example.module07_module393_module4
...
class ClassAAA {
	...
	fun method1(
		...
		param0.requestMore(5079365237331453796)
	...
	fun method2(
		...
		param0.request(3697942542790497569)
	...
	fun method3(
		...
		val local_var_2_4: io.reactivex.subscribers.TestSubscriber<kotlin.Any> = io.reactivex.subscribers.TestSubscriber()
		local_var_2_4.requestMore(8375997550281463854)
