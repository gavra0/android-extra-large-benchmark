...
class ClassAAC {
	...
	fun method0(
		...
		for (iAb in 0..5) {
			...
			val local_var_3_2: io.reactivex.schedulers.TestScheduler = io.reactivex.schedulers.TestScheduler()
			local_var_3_2.triggerActions()

			local_var_3_0.requestMore(-4708666715051708177)
	...
	fun method4(
		...
		val local_var_2_6: io.reactivex.subscribers.TestSubscriber<kotlin.Any> = io.reactivex.subscribers.TestSubscriber()
		local_var_2_6.request(-4873783733193538551)
